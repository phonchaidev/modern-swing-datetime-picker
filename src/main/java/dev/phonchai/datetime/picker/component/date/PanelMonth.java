...
public class PanelMonth extends JPanel {
    ...
    private void init() {
        ...
        final int count = 12;
        Font monthButtonFont = AppFont.resolveMonthButtonFont(datePicker);
        for (int i = 0; i < count; i++) {
            final int month = i;
            ButtonMonthYear button = new ButtonMonthYear(datePicker, i);
            button.setText(datePicker.getMonths()[i]);
            button.setFont(monthButtonFont);
    ...
    public void updateUI() {
        super.updateUI();
        Font monthButtonFont = AppFont.resolveMonthButtonFont(this);
