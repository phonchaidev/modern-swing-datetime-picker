...
public class ButtonDate extends JButton {
    ...
    public ButtonDate(DatePicker datePicker, SingleDate date, boolean enable, int rowIndex) {
        ...
        setText(date.getDay() + "");
        init(enable);
        setFont(AppFont.resolveDayButtonFont(datePicker));
    }
    ...
    private void init(boolean enable) {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (datePicker.isEnabled() && isEnabled()
            ...
            public void mouseEntered(MouseEvent e) {
                if (datePicker.isEnabled()) {
                    ...
                    if (datePicker.getDateSelectionModel()
                            .getDateSelectionMode() == DatePicker.DateSelectionMode.BETWEEN_DATE_SELECTED
    ...
    public void updateUI() {
        super.updateUI();
        setFont(AppFont.resolveDayButtonFont(this));
    }
